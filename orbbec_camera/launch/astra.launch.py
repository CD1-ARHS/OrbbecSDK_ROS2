...
def generate_launch_description():
    ...
    args = [
        ...
        # Modify these lines to reduce the color stream to lower bandwidth settings
        ...
        DeclareLaunchArgument('ir_width', default_value='320'),
        DeclareLaunchArgument('ir_height', default_value='240'),
        DeclareLaunchArgument('ir_fps', default_value='30'),  # You can also try 15 or 10 fps
